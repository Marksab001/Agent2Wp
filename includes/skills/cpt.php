...
namespace Agent2Wp\Skills\Cpt;

if (!defined('ABSPATH')) {
    exit();
}

const POST_TYPE = 'agent2wp_skill';
...
function register(): void
{
    ...
    register_post_type(POST_TYPE, [
        ...
        'has_archive' => false,
        'rewrite' => false,
        'capability_type' => ['agent2wp_skill', 'agent2wp_skills'],
        'map_meta_cap' => true,
        'capabilities' => [
            'read' => $capability,
    ...
    $auth = static fn(): bool => \agent2wp_current_user_can_manage();
