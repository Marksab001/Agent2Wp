...
// Skills is registered as a submenu under the Agent2Wp top-level menu;
// run after Agent2Wp's main menu callback (priority 10) attaches the
// parent slug `agent2wp-connect`. A second pass at a higher priority
...
add_filter('agent2wp_skill_lookup_sources', __NAMESPACE__ . '\\BuiltIn\\register');
add_filter('agent2wp_discover_abilities_instructions', __NAMESPACE__ . '\\Catalog\\inject', priority: 10);
