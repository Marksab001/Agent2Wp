...
namespace Agent2Wp\Skills\Abilities\SkillDelete;
...
function register(): void
{
    ...
    wp_register_ability('agent2wp/skill-delete', [
        'label' => __('Delete Skill', domain: 'agent2wp'),
        'description' => __(
            'Move a Agent2Wp user skill to trash. Pass `permanent=true` to skip trash and delete immediately.',
            domain: 'agent2wp',
        ),
        'category' => 'skill',
        'input_schema' => [
