...
namespace Agent2Wp\Skills\Catalog;
...
/**
 * Prepend the unified skill catalog block to the Agent2Wp discover-abilities
 ...
 * `agent2wp_skill_lookup_sources` automatically appear here under their
 * source label.
 */
...
function render(array $skills): string
{
    $lines = [
        ...
        '',
        'When a skill description matches the user\'s request, call `agent2wp/skill-get` with the slug to load its full instructions before starting work.',
        '',
    ];
