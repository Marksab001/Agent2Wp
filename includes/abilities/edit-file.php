...
wp_register_ability('agent2wp/edit-file', [
    'label' => __('Edit File', domain: 'agent2wp'),
    'description' => __(
    ...
    'execute_callback' => 'agent2wp_edit_file',
 ...
 */
function agent2wp_edit_replace_first(string $content, string $old_string, string $new_string): string
{
 ...
 */
function agent2wp_edit_file($input)
{
    ...
    $new_content = $replace_all
        ...
        : agent2wp_edit_replace_first($content, $old_string, $new_string);
