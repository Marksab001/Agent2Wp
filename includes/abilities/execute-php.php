...
wp_register_ability('agent2wp/execute-php', [
    'label' => __('Execute PHP Code', domain: 'agent2wp'),
    'description' => __(
    ...
    'execute_callback' => 'agent2wp_execute_php',
    ...
    'meta' => [
        ...
        'annotations' => [
            'instructions' => implode("\n", [
                ...
                '- Execution has a ' . AGENT2WP_MAX_EXECUTION_TIME . ' second time limit.',
                '',
                'SANDBOX CONTEXT:',
                '- To create persistent PHP functionality, write files to the sandbox',
                '  (wp-content/agent2wp-sandbox/) using the write-file ability.',
 ...
 */
function agent2wp_execute_php($input)
{
    ...
    set_time_limit(AGENT2WP_MAX_EXECUTION_TIME);
