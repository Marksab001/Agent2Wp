...
wp_register_ability('agent2wp/create-upload-link', [
    'label' => __('Create Upload Link', domain: 'agent2wp'),
    'description' => __(
    ...
    'execute_callback' => 'agent2wp_create_upload_link',
    ...
    'meta' => [
        ...
        'annotations' => [
            'instructions' => implode("\n", [
                ...
                'PHP files (*.php) and PHP execution control files can ONLY be uploaded to wp-content/agent2wp-sandbox/.',
 ...
 */
function agent2wp_create_upload_link($input)
{
    ...
    $token = agent2wp_sign_upload_payload($payload);
    if (is_wp_error($token)) {
        return $token;
    }

    $upload_url = rest_url('agent2wp/v1/upload');
    $token_header = 'X-Agent2Wp-Upload-Token';
