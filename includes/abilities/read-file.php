...
wp_register_ability('agent2wp/read-file', [
    'label' => __('Read File', domain: 'agent2wp'),
    'description' => __(
    ...
    'execute_callback' => 'agent2wp_read_file',
 ...
 */
function agent2wp_read_file($input)
{
    $resolved = agent2wp_resolve_path(path: (string) $input['path'], must_exist: true);
    ...
    $is_text = agent2wp_is_text_mime_type($mime_type) && mb_check_encoding(value: $content, encoding: 'UTF-8');
 ...
 * @return bool
 */
function agent2wp_is_text_mime_type($mime_type)
{
