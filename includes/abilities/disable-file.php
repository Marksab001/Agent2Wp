...
wp_register_ability('agent2wp/disable-file', [
    'label' => __('Disable File', domain: 'agent2wp'),
    'description' => __(
    ...
    'input_schema' => [
        ...
        'properties' => [
            'path' => [
                'type' => 'string',
                'description' => 'Path to the sandbox file to disable. Relative paths are resolved from ABSPATH. Must be inside wp-content/agent2wp-sandbox/.',
                'minLength' => 1,
            ],
        ],
        'required' => ['path'],
    ...
    'execute_callback' => 'agent2wp_disable_file',
    ...
    'meta' => [
        ...
        'annotations' => [
            'instructions' => implode("\n", [
                'SANDBOX NOTES:',
                '- Only files inside wp-content/agent2wp-sandbox/ (the PHP sandbox) can be disabled.',
 ...
 */
function agent2wp_disable_file($input)
{
    $resolved = agent2wp_resolve_path((string) $input['path'], must_exist: true);
