...
/**
 * Ability: Discover Abilities (Agent2Wp replacement).
 *
 * Replaces the MCP Adapter's bundled discover-abilities tool so the response
 * includes Agent2Wp's environment/usage instructions alongside the list of
...
wp_register_ability('mcp-adapter/discover-abilities', [
    'label' => __('Discover Abilities', domain: 'agent2wp'),
    'description' => __(
    ...
    'output_schema' => [
        'type' => 'object',
        'properties' => [
            'agent2wp_instructions' => [
                'type' => 'string',
                'description' => 'Agent2Wp environment and usage guidance for the agent.',
            ],
            'abilities' => [
                'type' => 'array',
                'items' => [
        ...
        'required' => ['agent2wp_instructions', 'abilities'],
    ],
    ...
    'execute_callback' => static function (): array {
        ...
        return [
            'agent2wp_instructions' => $instructions,
